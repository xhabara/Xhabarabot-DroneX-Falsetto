...
// Styling buttons
styleAutoButton(autoButton1, '#BE1B1B');  // Red for A
...
styleAutoButton(autoButton2, '#19C320');  // Yellow for B
...
styleAutoButton(autoButton3, '#1F80AC');  // Green for C
}

function styleAutoButton(button, bgColor) {
  button.style('background-color', bgColor);
  button.style('color', '#F7F1F1');  // White text
